...
2) While preliminary work to support subdirectories has been written, it is untested and likely contains bugs.
As of now, the file system is limited to the root directory, in which users may create, delete, read from,
and write to files.
...
"sfs_test<x>" - 5 test files, provided to see whether the file system functions properly. These have been
                ...
                Tests 3 and 4 are special, they were not required and I never focused on making them work.
